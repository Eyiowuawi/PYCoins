  ...
  const [businessForm, setBusinessForm] = useState({
    ...
    businessIndustry: {
      ...
      options: [
        ...
        { id: 3, label: "Business Support and Supplies" },
        { id: 4, label: "Computer and Electronics Sales" },
        { id: 5, label: "Cryptocurrency" },
        { id: 6, label: "Education " },
        { id: 6, label: "Entertainment " },
        { id: 6, label: "Food & Dining" },
        { id: 6, label: "Health and Medicine" },
        { id: 6, label: "Home and Garden" },
        { id: 6, label: "Legal and Financial Manufacturing " },
        { id: 6, label: "Merchants (Small SMEs and Retail" },
        { id: 6, label: "Personal Care & Services" },
        { id: 6, label: "Real Estate" },
        { id: 6, label: "Software Development" },
        { id: 6, label: "Travel and Transportation" },
        { id: 6, label: "Others" },
      ],
      singleSelect: true,
      validation: required,
